...
| Individually fair ranking on synthetic data <br> <small> Ranking algorithm trained on a randomly generated 2-dimensional data with one dimension explicitly specified as a protected attribute.</small>   | [![Jupyter notebook](https://img.shields.io/badge/jupyter-notebook-orange?style=flat&logo=Jupyter)](https://github.com/IBM/inFairness/blob/main/examples/fair-ranking-synthetic-data/synth_senstir_demo.ipynb) |  [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/ibm/infairness/main?labpath=examples%2Ffair-ranking-synthetic-data%2Fsynth_senstir_demo.ipynb)    |
